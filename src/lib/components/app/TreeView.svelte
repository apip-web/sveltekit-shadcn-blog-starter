...
<ul>
  <li class="folder">
    ...
    <ul>
      ...
      <li class="folder">
        <div on:click={toggle}>src</div>
        <ul>
          <li class="file">app.d.ts</li>
          <li class="file">app.html</li>

          <li class="folder">
            <div on:click={toggle}>lib</div>
            <ul>
              <li class="folder">
                <div on:click={toggle}>assets</div>
                <ul>
              ...
              <li class="folder">
                <div on:click={toggle}>components</div>
                <ul>
                  <li class="folder">
                    <div on:click={toggle}>app</div>
                    <ul>
                  ...
                  <li class="folder">
                    <div on:click={toggle}>ui</div>
                    <ul>
                      <li class="folder">
                        <div on:click={toggle}>badge</div>
                        <ul>
                      ...
                      <li class="folder">
                        <div on:click={toggle}>button</div>
                        <ul>
                      ...
                      <li class="folder">
                        <div on:click={toggle}>command</div>
                        <ul>
                      ...
                      <li class="folder">
                        <div on:click={toggle}>dialog</div>
                        <ul>
                      ...
                      <li class="folder">
                        <div on:click={toggle}>input-group</div>
                        <ul>
                          <li class="file">index.ts</li>
                          <li class="file">input-group-addon.svelte</li>
                          <li class="file">input-group-button.svelte</li>
                          <li class="file">input-group-input.svelte</li>
                          <li class="file">input-group.svelte</li>
                          <li class="file">input-group-textarea.svelte</li>
                          <li class="file">input-group-text.svelte</li>
                        </ul>
                      </li>

                      <li class="folder">
                        <div on:click={toggle}>navigation-menu</div>
                        <ul>
                          <li class="file">index.ts</li>
                          <li class="file">navigation-menu-content.svelte</li>
                          <li class="file">navigation-menu-indicator.svelte</li>
                          <li class="file">navigation-menu-item.svelte</li>
                          <li class="file">navigation-menu-link.svelte</li>
                          <li class="file">navigation-menu-list.svelte</li>
                          <li class="file">navigation-menu.svelte</li>
                          <li class="file">navigation-menu-trigger.svelte</li>
                          <li class="file">navigation-menu-viewport.svelte</li>
                        </ul>
                      </li>

                      <li class="folder">
                        <div on:click={toggle}>separator</div>
                        <ul>
                          <li class="file">index.ts</li>
                          <li class="file">separator.svelte</li>
                        </ul>
                      </li>

                      <li class="folder">
                        <div on:click={toggle}>sheet</div>
                        <ul>
                          <li class="file">index.ts</li>
                          <li class="file">sheet-close.svelte</li>
                          <li class="file">sheet-content.svelte</li>
                          <li class="file">sheet-description.svelte</li>
                          <li class="file">sheet-footer.svelte</li>
                          <li class="file">sheet-header.svelte</li>
                          <li class="file">sheet-overlay.svelte</li>
                          <li class="file">sheet-portal.svelte</li>
                          <li class="file">sheet.svelte</li>
                          <li class="file">sheet-title.svelte</li>
                          <li class="file">sheet-trigger.svelte</li>
                        </ul>
                      </li>

                      <li class="folder">
                        <div on:click={toggle}>textarea</div>
                        <ul>
                          <li class="file">index.ts</li>
                  ...
                  <li class="folder">
                    <div on:click={toggle}>config</div>
                    <ul>
              ...
              <li class="folder">
                <div on:click={toggle}>routes</div>
                <ul>
                  <li class="folder">
                    <div on:click={toggle}>about</div>
                    <ul>
                      <li class="file">+page.svelte</li>
                    </ul>
                  </li>
                  <li class="folder">
                    <div on:click={toggle}>api</div>
                    <ul>
                      <li class="folder">
                        <div on:click={toggle}>search</div>
                        <ul>
                  ...
                  <li class="folder">
                    <div on:click={toggle}>authors</div>
                    <ul>
                      <li class="folder">
                        <div on:click={toggle}>[author]</div>
                        <ul>
                          <li class="file">+page.svelte</li>
                  ...
                  <li class="folder">
                    <div on:click={toggle}>robots.txt</div>
                    <ul>
                      <li class="file">+server.ts</li>
                    </ul>
                  </li>
                  ...
                  <li class="folder">
                    <div on:click={toggle}>rss.xml</div>
                    <ul>
                      <li class="file">+server.ts</li>
                    </ul>
                  </li>
                  ...
                  <li class="folder">
                    <div on:click={toggle}>sitemap.xml</div>
                    <ul>
                      <li class="file">+server.ts</li>
                    </ul>
                  </li>
      ...
      <li class="folder">
        <div on:click={toggle}>static</div>
        <ul>
          <li class="folder">
            <div on:click={toggle}>images</div>
            <ul>
      ...
      <li class="folder">
        <div on:click={toggle}>.vscode</div>
        <ul>
