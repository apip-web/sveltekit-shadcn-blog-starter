...
<h2>📦 sveltekit-shadcn-blog-starter</h2>

<ul id="treeview" class="tree-root">
    ...
    <ul>
            ...
            <ul>
              ...
              <li class="folder">ui
                <ul>
                  ...
                  <li class="folder">navigation-menu
                    <ul>
                      <li class="file">index.ts</li>
                  ...
                  <li class="folder">separator
                    <ul>
                      <li class="file">index.ts</li>
                      <li class="file">separator.svelte</li>
                    </ul>
                  </li>
                  <li class="folder">sheet
                    <ul>
                      <li class="file">index.ts</li>
      ...
      <li class="folder">routes
        <ul>
          ...
          <li class="folder">authors
            <ul>
              <li class="folder">[author]
                <ul>
                  <li class="file">+page.svelte</li>
          ...
          <li class="file">+page.svelte</li>
          <li class="folder">robots.txt
            <ul>
              <li class="file">+server.ts</li>
            </ul>
          </li>
          <li class="folder">rss.xml
            <ul>
              <li class="file">+server.ts</li>
            </ul>
          </li>
          <li class="folder">sitemap.xml
            <ul>
              <li class="file">+server.ts</li>
            </ul>
          </li>
